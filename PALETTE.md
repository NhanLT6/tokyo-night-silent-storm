...
| Level | Hex | HSL (approx) | Used for |
|-------|-----|--------------|---------|
| whisper | `c2c0e8` | 245°, 45%, 83% | Parameter, reassigned parameter, JS/HTTP parameter, anonymous class parameter |
...
| Level | Hex | HSL (approx) | Used for |
|-------|-----|--------------|---------|
| whisper | `bdd8e8` | 208°, 47%, 82% | TS type parameter, annotation attribute name |
